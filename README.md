...
- Basic Solidity Smart Contract for creating your own Badger Strategy ([`contracts/StrategyGenericSolidexHelper.sol`](contracts/StrategyGenericSolidexHelper.sol))
...
2. Write the Strategy Code in StrategyGenericSolidexHelper.sol
...
[`contracts/StrategyGenericSolidexHelper.sol`](contracts/StrategyGenericSolidexHelper.sol) is where you implement your own logic for your strategy. In particular:

- Customize the `initialize` Method
- Set a name in `StrategyGenericSolidexHelper.getName()`
- Set a version in `StrategyGenericSolidexHelper.version()`
- Write a way to calculate the want invested in `StrategyGenericSolidexHelper.balanceOfPool()`
- Write a method that returns true if the Strategy should be tended in `StrategyGenericSolidexHelper.isTendable()`
- Set a version in `StrategyGenericSolidexHelper.version()`
