...
from brownie import accounts, network, StrategyGenericSolidexHelper, SettV4, BadgerRegistry
...
def main():
    ...
    strategy = StrategyGenericSolidexHelper.at("0x809990849D53a5109e0cb9C446137793B9f6f1Eb")
